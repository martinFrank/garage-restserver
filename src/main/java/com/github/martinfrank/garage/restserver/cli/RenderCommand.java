package com.github.martinfrank.garage.restserver.cli;
...
public class RenderCommand extends ConfiguredCommand<GarageRestServerConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<GarageRestServerConfiguration> bootstrap,
                       Namespace namespace,
                       GarageRestServerConfiguration configuration) throws Exception {
